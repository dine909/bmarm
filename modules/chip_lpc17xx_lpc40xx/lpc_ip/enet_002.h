/*
 * @brief Ethernet (002) control functions
 *
 * @note
...
#ifndef __ENET_002_H_
#define __ENET_002_H_
...
/** @defgroup IP_ENET_002 IP: Ethernet (002) register block and driver
 * @ingroup IP_Drivers
 * This MAC/Ethernet driver provides hardware support for controllers
 * found in LPC2xxx, LPC17xx/40xx, and LPC32xx devices.
 * @{
 */

/**
 * @brief Ethernet (002) MAC register block structure
 */
typedef struct {
...
} IP_ENET_002_TRANSFER_INFO_Type;
...
typedef struct {
	...
	IP_ENET_002_TRANSFER_INFO_Type RX;	/*!< Receive block registers */
	IP_ENET_002_TRANSFER_INFO_Type TX;	/*!< Transmit block registers */
...
} IP_ENET_002_MODULE_CTRL_Type;

/**
 * @brief Ethernet register block structure
 */
typedef struct {
	IP_ENET_002_MAC_Type  MAC;				/*!< MAC registers */
	uint32_t RESERVED1[45];
	IP_ENET_002_CONTROL_Type CONTROL;		/*!< Control registers */
	uint32_t RESERVED4[34];
	IP_ENET_002_RXFILTER_Type RXFILTER;		/*!< RxFilter registers */
	uint32_t RESERVED6[882];
	IP_ENET_002_MODULE_CTRL_Type MODULE_CONTROL;	/*!< Module Control registers */
} IP_ENET_002_Type;
 ...
 */
STATIC INLINE uint16_t IP_ENET_GetTXProduceIndex(IP_ENET_002_Type *pEnet)
{
 ...
 */
STATIC INLINE uint16_t IP_ENET_GetTXConsumeIndex(IP_ENET_002_Type *pEnet)
{
 ...
 */
STATIC INLINE uint16_t IP_ENET_GetRXProduceIndex(IP_ENET_002_Type *pEnet)
{
 ...
 */
STATIC INLINE uint16_t IP_ENET_GetRXConsumeIndex(IP_ENET_002_Type *pEnet)
{
 ...
 * @param	pEnet	    : Pointer to selected ENET peripheral
 * @param	macAddr		: Pointer to the 6 bytes MAC address
 * @return	Nothing
 */
 ...
 * @param	descNum	: Number of desciptors
 * @return	Nothing
 */
...
/**
 * @brief	Get status for the descriptor list
