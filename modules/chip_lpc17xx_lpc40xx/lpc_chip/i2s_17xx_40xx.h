 ...
 */
STATIC INLINE void Chip_I2S_Send(uint32_t data)
{
	IP_I2S_Send(LPC_I2S, data);
}
 ...
 */
STATIC INLINE uint32_t Chip_I2S_Receive(void)
{
	return IP_I2S_Receive(LPC_I2S);
}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_I2S_Start(uint8_t TRMode)
{
	IP_I2S_Start(LPC_I2S, TRMode);
}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_I2S_Pause(uint8_t TRMode)
{
	IP_I2S_Pause(LPC_I2S, TRMode);
}
 ...
 */
STATIC INLINE void Chip_I2S_Mute(FunctionalState NewState)
{
	IP_I2S_Mute(LPC_I2S, NewState);
}
 ...
 */
STATIC INLINE void Chip_I2S_Stop(uint8_t TRMode)
{
	IP_I2S_Stop(LPC_I2S, TRMode);
}
 ...
 */
STATIC INLINE void Chip_I2S_ModeConfig(uint8_t TRMode,
									   uint32_t clksel,
									   uint32_t fpin,
									   uint32_t mcena)
{
	IP_I2S_ModeConfig(LPC_I2S, TRMode, clksel, fpin, mcena);
}
 ...
 */
STATIC INLINE uint8_t Chip_I2S_GetLevel(uint8_t TRMode)
{
	return IP_I2S_GetLevel(LPC_I2S, TRMode);
}
 ...
 * @return	Nothing
 */
void Chip_I2S_DMA_Cmd(uint8_t TRMode, uint8_t DMANum, FunctionalState NewState, uint8_t FIFO_Depth);
